...
def main() -> None:
        ...
        recs.append(
            {
                ...
                "err_vS": float(r["err_vS"]),
                "eoc_vS": float("nan") if prev is None else _eoc(prev["h"], r["h"], prev["err_vS"], r["err_vS"]),
                "err_p": float(r["err_p"]),
                ...
                "err_X": float(r["err_X"]),
                "eoc_X": float("nan") if prev is None else _eoc(prev["h"], r["h"], prev["err_X"], r["err_X"]),
            }
        )
    ...
    if bool(args.convergence):
        ...
        series = [
            ...
            ("vS", np.asarray([r["err_vS"] for r in rows], dtype=float)),
            ...
            ("X", np.asarray([r["err_X"] for r in rows], dtype=float)),
        ]
