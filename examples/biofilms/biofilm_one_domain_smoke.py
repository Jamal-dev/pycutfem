...
def _build_problem(*, nx: int, ny: int, q: int, seed: int, dt_val: float, theta: float):
...
def main():
    ...
    dh, forms = _build_problem(nx=args.nx, ny=args.ny, q=args.q, seed=args.seed, dt_val=args.dt, theta=args.theta)
