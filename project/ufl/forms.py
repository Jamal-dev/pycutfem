...
class BoundaryCondition:
    ...
    def __init__(self, type_, tag, value):
        t = type_.lower()
...
def assemble_form(equation, mesh, quad_order=None):
    from ufl.compilers import FormCompiler
    compiler = FormCompiler(mesh, quad_order)
    return compiler.assemble(equation)
