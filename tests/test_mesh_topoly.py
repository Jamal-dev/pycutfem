...
class TestMeshTopology:
    def test_get_q1_corners(self):
        ...
        corners_e0 = mesh._get_element_corner_global_indices(0)
        ...
        corners_e3 = mesh._get_element_corner_global_indices(3)
    ...
    def test_get_q2_corners(self):
        ...
        actual_corners = mesh._get_element_corner_global_indices(0)
    ...
    def test_build_edges_q2(self):
        ...
        # Node grid for 2x1 Q2 mesh:
        #  8-- 9--10--11--12
        #  |   |   |   |   |
        #  4---5---6---7
        #  |   |   |   |   |
        #  0---1---2---3
        # Oops, the grid is more complex. Let's trace it.
        ...
        #  |   |   |   |   |
        #  0---1---2---3---4
        # Elem 0 corners: GIDs 0, 2, 7, 5
        # Elem 1 corners: GIDs 2, 4, 9, 7
        # The shared edge is between nodes 2 and 7.
        shared_edge_nodes = tuple(sorted((2, 7)))
